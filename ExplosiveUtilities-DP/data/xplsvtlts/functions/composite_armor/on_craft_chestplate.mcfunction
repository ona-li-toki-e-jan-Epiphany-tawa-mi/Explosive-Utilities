...
give @p iron_chestplate{display:{Name:'{"text":"Composite Chestplate","italic":false}'},Enchantments:[{id:"minecraft:blast_protection",lvl:2s}],Trim:{material:"minecraft:copper",pattern:"minecraft:sentry"}} 1