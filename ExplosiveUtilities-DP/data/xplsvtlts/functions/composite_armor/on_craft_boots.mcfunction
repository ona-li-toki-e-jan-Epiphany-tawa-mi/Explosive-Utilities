...
give @p iron_boots{display:{Name:'{"text":"Composite Boots","italic":false}'},Enchantments:[{id:"minecraft:blast_protection",lvl:2s}],Trim:{material:"minecraft:copper",pattern:"minecraft:sentry"}} 1