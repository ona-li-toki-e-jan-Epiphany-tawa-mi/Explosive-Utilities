##
# Runs once every tick whilst players with a tnt wand explosive punch cooldown still exist.
...
execute store success score _exists_players_with_cooldown xplsvtlts run execute as @a[scores={xplsvtlts_tnt_wand_punch_cooldown=1..}] run function xplsvtlts:tnt_wand/cooldown/on_tick_punch_cooldown
