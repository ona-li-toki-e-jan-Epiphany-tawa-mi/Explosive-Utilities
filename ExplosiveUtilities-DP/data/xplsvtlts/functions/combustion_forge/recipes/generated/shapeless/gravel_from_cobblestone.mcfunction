...
# Create result.
execute if score _valid_ingredient_count xplsvtlts matches 1 run summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:gravel",Count:1b}}
...
execute if score _valid_ingredient_count xplsvtlts matches 1 run function xplsvtlts:combustion_forge/recipes/generated/shapeless/gravel_from_cobblestone
