...
#   [_uuid0, _uuid1, _uuid2, _uuid3] (scoreboard: xplsvtlts) - the UUID of the player who threw it.
#   _success (scoreboard: xplsvtlts) - intialize to 0. Used to check to see if a trident was found
#
# Returns:
...
execute if score _success xplsvtlts matches 1 run function xplsvtlts:reactive_plating/trident/detonate
