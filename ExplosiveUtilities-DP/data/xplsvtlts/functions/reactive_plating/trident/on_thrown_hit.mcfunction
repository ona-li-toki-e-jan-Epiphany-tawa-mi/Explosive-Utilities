...
execute as @e[type=minecraft:trident,sort=nearest,tag=!xplsvtlts_exploded_reactive_trident,nbt={Trident:{tag:{"Reactive":1b}}}] run function xplsvtlts:reactive_plating/trident/_try_detonate
